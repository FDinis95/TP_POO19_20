...
${OBJECTDIR}/CrazyDriver.o: CrazyDriver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CrazyDriver.o CrazyDriver.cpp

${OBJECTDIR}/DGV.o: DGV.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DGV.o DGV.cpp
...
${OBJECTDIR}/PilotoRapido.o: PilotoRapido.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PilotoRapido.o PilotoRapido.cpp

${OBJECTDIR}/PilotoSurpresa.o: PilotoSurpresa.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PilotoSurpresa.o PilotoSurpresa.cpp
